  ...
  return (
    <>
      ...
      >
        ...
        <Link onClick={() => setIsOpen(false)} to="/generate" className="">
          Generate
        </Link>

        <Link onClick={() => setIsOpen(false)} to="/my-generation" className="">
          My Generations
        </Link>
        ...
        <Link onClick={() => setIsOpen(false)} to="/login" className="">
          Login
        </Link>
