...
const Generate = () => {
  ...
  const [colorSchmeId, setColorSchmeId] = useState<string>(colorSchemes[0].id);
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg border border-white/12 bg-black/20 text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-pink-400"
                    />
