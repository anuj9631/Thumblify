...
export default function FeaturesSection() {
  return (
    <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
      <SectionTitle
        text1="Features"
        text2="Why our AI generator stands out?"
        text3="Smart automation, instant results, and beautifully designed thumbnails powered by AI."
      />
      ...
      <div className="mt-40 relative mx-auto max-w-5xl">
        ...
        >
          Our AI analyzes what makes content perform and creates thumbnails that
          stand out naturally.
        </motion.p>
        <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
          ...
          >
            ...
            <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">
              Boost you views with AI-optimized designs{" "}
            </h3>
            <p className="text-slate-300 mt-2">
              Stop guessing and start creating. Our AI designs visuals built to
